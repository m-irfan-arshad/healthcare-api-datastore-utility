...
public class HL7v2MessageDelete {
  ...
  private static final NetHttpTransport HTTP_TRANSPORT = new NetHttpTransport();
    ...
    public static void hl7v2MessageDeleteFromHL7Store(String hl7v2StoreName) throws IOException {
        ...
        do {
            ...
            if (messageResponse.getHl7V2Messages() != null) {
                ...
                for (Message message : messageResponse.getHl7V2Messages()) {
                    HL7v2MessageDelete.hl7v2MessageDelete(message.getName());

                    System.out.println("HL7v2 message deleted.");
                }
            }
            else {
                System.out.println("No HL7 messages to delete.");
            }
