...
public class FhirResourceGet {
  ...
  public static void fhirResourceGet(String resourceName) throws IOException, URISyntaxException {
    ...
    String uri = "https://healthcare.googleapis.com/v1/projects/medtel-349114/locations/us-central1/datasets/datastore/fhirStores/yogitafhirstore/fhir/Patient/ef4d14c3-eebe-40";
